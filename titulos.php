        ...
        <script>
            ...
            $(document).ready(function() {
                $("#grid").kendoGrid({
                    dataSource: {                        
                        transport: {
                            read: {
                                type: "GET",
                                dataType: "json",
                                url: baseURL + "/jsonTables.php?table=Titulos"                           
                            },
                            create: {
                                type: "GET",
                                url: baseURL + "/jsonSave.php?table=Titulos",
                                data: {},
                            ...
                            update: {
                                type: "GET",
                                url: baseURL + "/jsonUpdate.php?table=Titulos",
                                data: {},
                                complete: function(jqXHR, textStatus) {
                                    if (textStatus == 'success') {
                                        $("#grid").data("kendoGrid").dataSource.read();
                            ...
                            destroy: {
                                type: "GET",
                                url: baseURL + "/jsonDelete.php?table=Titulos",
                                data: {},
                                complete: function(jqXHR, textStatus) {
                                    if (textStatus == 'success') {
                                        $("#grid").data("kendoGrid").dataSource.read();
                        ...
                        schema: {
                            model: {
                                id:"idTitulos",
                                fields: {
                                    idTitulos: { type: "number", editable: false },
                                    nombre: { type: "string" },
                    ...
                    editable: "inline",
                    toolbar: [
                        { name: "create", text: "Agregar título" }
                    ],
                    columns: [{
                            field:"idTitulos",
                            title: "ID"
                ...
                $("#buttonAddImgs").click(function() {
                    var url = "agregarImgs.php?place=titulos";
                ...
                var imagesDS = new kendo.data.DataSource({
                    transport: {
                        read: {
                            type: "POST",
                            dataType: "json",
                            url: baseURL + "/jsonImages.php?place=titulos",
                            data: {}
                        }
                    },
                    schema: {
